 ...
 * Blowfish加密算法Java实现
 */
public class BlowfishEncryptionProcessor implements EncryptionProcessor {
...
*/
    ...
    */
    ...
    public String encode(String secretKey, String text) {
        return new String(encrypt(secretKey, text));
    }

    @Override
    public String decode(String secretKey, String text) {
        return new String(decrypt(secretKey, text.getBytes(StandardCharsets.UTF_8)));
    }
}
